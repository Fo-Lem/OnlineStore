            ...
            <ul class="space-y-2 font-medium">
              <li class="flex gap-5 justify-between">
                ...
                <button
                  ...
                  aria-controls="default-sidebar"
                  type="button"
                  class="inline-flex items-center p-2 h-fit text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                  @click="mobileMenuOpen = !mobileMenuOpen"
                >
                  <span class="sr-only">Open sidebar</span>
                  <svg
