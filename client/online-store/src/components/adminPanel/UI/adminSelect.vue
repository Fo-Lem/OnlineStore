<template lang="">
    <div class="flex gap-2 flex-col ">
        ...
        <div class="flex items-center gap-5">
            <select :id="selectIn" @:change="changeOption" class="sm:max-w-md sm:text-sm sm:leading-6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg flex w-full p-2.5 ">
            ...
            <svg class="h-10 w-10 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg cursor-pointer hover:bg-gray-200" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
