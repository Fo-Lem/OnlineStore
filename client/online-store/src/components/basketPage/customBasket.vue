...
export default defineComponent({
  ...
  methods: {
    ...
    checkout() {
      checkout(this.catalog, this.basket, this.user, this.address)
    },
    ...
    <div v-if="Object.keys(basket).length > 0" class="mx-auto lg:flex lg:space-x-6">
      <div class="rounded-lg lg:w-2/3">
        <div
          ...
          class="justify-between relative gap-5 mb-6 rounded-lg p-6 border border-primary md:flex md:justify-start"
        >
            ...
            <div class="flex flex-col justify-end gap-5 items-end">
              <div class="flex items-center">
                ...
                <input
                  ...
                  class="text-center text-lg w-16 h-full border-primary-light-1 border-t-2 border-b-2 text-primary-dark bg-primary-light-2 focus:outline-none"
          ...
          <svg
            ...
            class="h-8 w-8 absolute top-5 right-5 cursor-pointer duration-150 hover:text-red-500"
